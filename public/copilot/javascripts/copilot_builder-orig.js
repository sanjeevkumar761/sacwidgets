(function () {
 ...
 <form id="form">
     ...
     <td>
     <p>OpenAI API key</p>
     <input id="builder_apiKey" type="text" placeholder="Enter OpenAI API key">
     </td>
     </tr>
     <tr>
     <td>
     <p>Result Max Length</p>
     <input id="builder_max_tokens" type="number" placeholder="Enter Token Limit">
     </td>
     </tr>
 ...
 `;
    class OpenAIBuilderPanel extends HTMLElement {
       constructor() {
          super();
